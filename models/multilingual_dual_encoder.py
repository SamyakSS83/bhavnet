    ...
    def test(self, test_loader, model_path):
        ...
        with torch.no_grad():
            for batch in tqdm(test_loader):
                ...
                # Attempt to recover word1/word2 from batched graphs
                # In PyG batching, data objects are concatenated; we retrieve original graph-level attributes
